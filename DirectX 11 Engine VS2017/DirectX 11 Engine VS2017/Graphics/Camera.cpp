...
void Camera::SetProjectionValues(float fovDegrees, float aspectRatio, float nearZ, float farZ)
{
	...
	this->projectionMatrix = XMMatrixPerspectiveFovLH(0.25f * XM_PI, aspectRatio, nearZ, farZ);
}
...
const XMVECTOR& Camera::GetCamTarget()
{
	return this->cam_target;
}
...
void Camera::UpdateViewMatrix() //Updates view matrix and also updates the movement vectors
{
	...
	cam_target =  XMVector3TransformCoord(this->DEFAULT_FORWARD_VECTOR, camRotationMatrix);
	...
	//Rebuild view matrix
	this->viewMatrix = XMMatrixLookAtLH(this->posVector, cam_target, upDir);
